...
tmux set-option -gq window-status-format "#[fg=blue,bg=#2F343F,nobold,nounderscore,noitalics]$CONFIG_NERDFONTS_LEFT#[fg=#2F343F,bg=blue,nobold,nounderscore,noitalics]#I#[fg=#2F343F,bg=black,nobold,nounderscore,noitalics]$CONFIG_NERDFONTS_RIGHT#[fg=#555555,bg=#2F343F,nobold,nounderscore,noitalics] $CONFIG_NERDFONTS_ICON_APPLICATION #W #[fg=#2F343F,bg=#2F343F,nobold,nounderscore,noitalics]$CONFIG_NERDFONTS_RIGHT"
